...
public class Account extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        //Active Record style
        //UI directly trigger from dao
        //no repo & viewModel use
        ...
        Executors.newSingleThreadExecutor().execute(() -> {
            ...
            requireActivity().runOnUiThread(() -> {
                ...
                //get the profile image from db if not upload img yet then use default image (puppy)
        ...
        //Set the button function to edit or save
        btnEdit.setOnClickListener(v -> {
            if (!isEditing) {
                ...
                // Remove click listener to prevent further uploads
            ...
            registerForActivityResult(
                    ...
                    uri -> {
                        if (uri != null) {
                            ...
                            //IMPORTANT to get permission to read the image
